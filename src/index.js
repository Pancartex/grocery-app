const groceryItems = [
  {
    ...
    image:
      "https://beatrice.ca/static/wp-content/uploads/updates/2pct-partly-skimmed-milk-1l-carton-nat-thumb.png",
    price: 1.99,
  },
  {
    name: "Chips",
    ...
    image:
      "https://image.made-in-china.com/202f0j00QPdYioAKwnbO/Three-Side-Seal-Food-Bag-Coffee-Packaging-Chips-Crisps.jpg",
    price: 4.99,
  },
  {
    name: "Eggs",
    ...
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSUDz5jZHOzGvdc9YByH2C8RMn8qgQcNdzVCg&usqp=CAU",
    price: 3.5,
  },
  {
    name: "Bread",
  ...
  },
  {
    ...
    image:
      "https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fstatic.onecms.io%2Fwp-content%2Fuploads%2Fsites%2F19%2F2019%2F07%2F09%2Fswiss-cheese-2000.jpg",
    price: 6.99,
  },
  {
    name: "oatmeal",
    ...
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTO1LyEXFu0_STKBppbvMEv8-qPiroO20wfsw&usqp=CAU",
    price: 3.99,
  },
  {
    name: "oreo",
    ...
    image:
      "https://imagesvc.meredithcorp.io/v3/mm/image?url=https%3A%2F%2Fstatic.onecms.io%2Fwp-content%2Fuploads%2Fsites%2F24%2F2020%2F08%2F14%2Foreo-hazelnut.jpg&q=60",
    price: 4.99,
  },
];
...
class Item {
  ...
  add() {
    ...
    if (this.checkoutItemQuantity > 0) {
      ...
      checkoutParagraph.textContent = `${
        this.checkoutItemQuantity
      }x ${name} - $${this.checkoutItemPrice.toFixed(2)}`;
      addedToCartHeader.textContent = `${currentTotal.toFixed(2)}`;
      quantityInput.value = 1;
      totalPriceParagraph.textContent = `Total: $${(
  ...
  setupEventListeners() {
    const { price, quantityInput } = this;
    const totalPriceParagraph = this.itemNode.querySelector("#total");
    const addToCart = this.itemNode.querySelector("button");
    const deleteFromCart = this.checkoutItemNode.querySelector(
      ".delete-checkout-btn"
    );
...
for (let itemData of groceryItems) {
...
checkoutBtn.addEventListener("click", () => {
  ...
  if (currentTotal <= 0.1) {
    ...
    modalText.textContent = `Congratulations! Your order of $${currentTotal.toFixed(
      2
